...
struct Kalimantan : public Polygon {
  Kalimantan() {
    ...
    addPoint(Point<double>(160, 390));
    //Lekukan bawah
    addPoint(Point<double>(245, 390));
    addPoint(Point<double>(245, 420));
    addPoint(Point<double>(305, 420));
    addPoint(Point<double>(305, 390));
    addPoint(Point<double>(385, 390));
    addPoint(Point<double>(385, 420));
    //lekukan bawah
    addPoint(Point<double>(430, 420));
    addPoint(Point<double>(430, 450));
    //Kanan
    addPoint(Point<double>(490, 450));
    addPoint(Point<double>(490, 420));
