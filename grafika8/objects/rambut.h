...
struct Rambut : public Polygon {
  Rambut() {
    ...
    addCurve(Point<double>(481, 600), Point<double>(460, 626), Point<double>(440, 650), Point<double>(470, 660));
    addCurve(Point<double>(471, 660), Point<double>(440, 650), Point<double>(420, 640), Point<double>(380, 620));
    //addPoint(Point<double>(380, 620));
    addCurve(Point<double>(380, 570), Point<double>(400, 540), Point<double>(415, 520), Point<double>(420, 500));
    //addPoint(Point<double>(420, 500));
    //addPoint(Point<double>(420, 380));
    //addPoint(Point<double>(390, 400));
    addCurve(Point<double>(390, 400), Point<double>(380, 250), Point<double>(360, 180), Point<double>(320, 160));
    ...
    addCurve(Point<double>(191, 320), Point<double>(190, 270), Point<double>(140, 280), Point<double>(200, 250));
    addPoint(Point<double>(201, 250));
    addCurve(Point<double>(201, 250), Point<double>(160, 270), Point<double>(140, 280), Point<double>(100, 370));
    ...
    addCurve(Point<double>(20, 559), Point<double>(40, 500), Point<double>(30, 440), Point<double>(10, 350));
    addPoint(Point<double>(10, 349));
    addCurve(Point<double>(10, 349), Point<double>(40, 170), Point<double>(100, 100), Point<double>(250, 30));	
